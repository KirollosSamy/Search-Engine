...
def search():
    ...
    return render_template("result.jinja", searchPhrase = search_phrase, result_list = listOfDictsRes, page = page, numberOfResults = numberOfResults, numberOfPages = math.ceil(responseJson["number"] / 10.0))
